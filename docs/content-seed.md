...
- Facebook: https://www.facebook.com/lukaszpiotrluczak
...
- Łuczak, Ł.P.; Ignaciuk, P.; Morawski, M.
  ...
  - DOI: 10.15439/2023F9991

- Łuczak, Ł.P.; Ignaciuk, P.; Morawski, M.
  - Title: MPTCP Congestion Control Algorithms for Streaming Applications.
  - In: Progress in Polish Artificial Intelligence Research 4
  - Publisher: Wydawnictwo Politechniki Łódzkiej (Łódź, Poland), 2023
  - Pages: 361–366
  - DOI: 10.34658/9788366741928.57

- Łuczak, Ł.P.; Ignaciuk, P.
  - Title: Congestion Control in Streaming Services with an On-Off MPTCP Algorithm.
  - Venue: 19th Conference on Computer Science and Intelligence Systems (FedCSIS 2024)
  - Location: Belgrade, Serbia
  - Dates: 2024-09-08 to 2024-09-11

- Łuczak, Ł.P.; Ignaciuk, P.
  - Title: An On-Off MPTCP Congestion Control Algorithm for Streaming Services.
  - Venue: European System, Software & Service Process Improvement & Innovation (EuroSPI² 2024)
...
- Talk title (EN): Are Frontend Developers at Risk? AI Is Already Writing HTML for Us…
- Talk title (PL): Czy programiści frontendu są zagrożeni? AI już pisze HTML za nas…
- Talk short description (EN):
  Generative AI is already writing HTML, CSS and entire UI components — but what does that mean for frontend developers?
  In this talk, we’ll explore real examples of how AI can accelerate (and sometimes break) modern web development,
  along with the risks, opportunities and skills that will matter most in the years ahead.
- Talk short description (PL):
  Generatywna AI coraz sprawniej pisze HTML, CSS i całe komponenty frontendowe.
  Czy to realne zagrożenie dla webdeveloperów, czy ogromna szansa na przyspieszenie pracy?
  Podczas sesji pokażę praktyczne przykłady z projektu, w którym AI jednocześnie pomagała…
